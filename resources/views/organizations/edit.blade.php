    ...
    <div class="modal-dialog modal-lg" role="document">
        <form id="formEditOgService" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" id="editOgServiceBody">
                    <input type="hidden" name="ogService_id" id="ogService_id" value="">
                    <div class="form-group row">
                        <label for="service_name" class="col-sm-12 col-md-4 col-lg-4 col-form-label">Service slug/nick name</label>
                        <div class="col-sm-12 col-md-8 col-lg-8">
                            <input type="text" class="form-control" id="service_name" name="service_name" placeholder="Service slug/nick name">
                        </div>
                    </div>
                </div>
                <div class="modal-footer">
