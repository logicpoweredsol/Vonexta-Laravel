      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-tools">
            ...
            <a href="{{ route('system.users.new') }}" class="btn btn-sm btn-primary">
                        ...
                        <tr>
                            ...
                            <td>
                                @if(Auth::user()->can('edit users'))
                                    <a href="{{ route('system.users.view', $user->id) }}" class="btn btn-sm btn-primary"><i class="fas fa-pen"></i><a>
                                @endif
...
@push('scripts')
    ...
    <script src="{{ asset('views/system/users/index.js') }}"></script>
@endpush
