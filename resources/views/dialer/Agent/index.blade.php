                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a
                                        href="{{ route('services.agents', ['service' => strtolower('dailer'), 'organization_services_id' => $organization_servicesID]) }}">{{
                                        $nick_name }}
                                    </a></li>
                    ...
                    <div class="card-header">
                      ...
                      <i class="fas fa-minus"></i>
                            ...
                            <a href="javascript:void(0);"
                                onclick='bulk_button_action("emergency",{{ $organization_servicesID }});'
                                class="btn btn-sm btn-warning check_btn d-none">
                                <i class="fas fa-sign-out-alt"></i> Emergency Logout
                            </a>

                            <a href="javascript:void(0);"
                                onclick='bulk_button_action("disable" ,{{ $organization_servicesID }});'
                                class="btn btn-sm btn-secondary check_btn d-none">
                                <i class="fas fa-ban"></i> Disable
                            </a>

                            <a href="javascript:void(0);"
                                onclick='bulk_button_action("delete" ,{{ $organization_servicesID }});'
                                class="btn btn-sm btn-danger check_btn d-none">
                                <i class="fas fa-trash"></i> Delete
                            </a>

                            <a href="javascript:void(0);" type="button" class="btn btn-sm btn-primary"
                                onclick="add_agent_model();"> <i class="fas fa-plus"></i> Add Agent</a>
                    ...
                    <div class="card-body" style="position: relative;">
                        <div class="acbz" style="position: absolute;width: 250px;right: 275px;top: 20px ;z-index:9;">
                            ...
                            <div class="btn-group" style="margin-left:50px;">
                                <button type="button" class="btn btn-default">Status - <span id="cur_status">All</span>
                                </button>
                                ...
                                <div class="dropdown-menu" role="menu">
                                    ...
                                    <a class="dropdown-item" href="javascript:"
                                        onclick="search_filter('Active')">Active</a>
                                    <a class="dropdown-item" href="javascript:"
                                        onclick="search_filter('Not Active')">Not Active</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <table id="tbl" class="table table-striped table-hover vonexta-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td> <input type="checkbox" style="width: 20px; height: 20px; margin-top: 7px;"
                                            value="{{ $userAgent->user }}" id="{{ $userAgent->user }}"
                                            class="form-control" onclick="bulk_button(this.id);"></td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu" role="menu">
                                                <a class="dropdown-item"
                                                    href="{{ route('services.agents.edit', ['service' => strtolower($service), 'organization_services_id' => $organization_servicesID, 'AgentID' => $userAgent->user]) }}">Edit</a>
                                                <a class="dropdown-item"
                                                    href="{{ route('services.agents.log', ['service' => strtolower($service), 'organization_services_id' => $organization_servicesID, 'AgentID' => $userAgent->user]) }}">Logs</a>
                                                <a class="dropdown-item" href="javascript:;"
                                                    onclick="update_skill_modal('{{ $service }}' , {{ $organization_servicesID }} ,{{ $userAgent->user }});">Update
                                                    Skills</a>


                                                <a class="dropdown-item" href="javascript:;"
                                                    onclick="EmergencyLogout('{{ $service }}' , {{ $organization_servicesID }} ,{{ $userAgent->user }}   )">Emergency
                                                    Logout</a>
                                        ...
                                        <div class="bs-stepper">
                                            <div class="bs-stepper-header" role="tablist">
                                                ...
                                                <div class="step" data-target="#skills-part">
                                                    <button type="button" class="step-trigger" role="tab"
                                                        aria-controls="skills-part" id="skills-part-trigger"
                                                ...
                                                <div class="step" data-target="#Success-part">
                                                    <button type="button" class="step-trigger" role="tab"
                                                        aria-controls="Success-part" id="Success-part-trigger">
                                            ...
                                            <div class="bs-stepper-content" id="add_agent_form">
                                                ...
                                                <form
                                                    action="{{ route('services.save-agent', ['service' => strtolower('Dailer')]) }}"
                                                    method="post">
                                                    <input type="hidden" id="organization_ser_id"
                                                        name="organization_servicesID"
                                                        value="{{ $organization_servicesID }}">
                                                    ...
                                                    <div id="Users-part" class="content" role="tabpanel"
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="user_group"
                                                                class="col-sm-2 col-form-label">User<span
                                                                    class="text-danger">*</span> </label>
                                                            <div class="col-md-7">
                                                                <select class="form-control select3"
                                                                    name="organization_user" id="organization_user">
                                                            ...
                                                            <div class="col-md-3">
                                                                <button type="button" class="btn btn-primary btn-sm"
                                                                    onclick="show_adduser_modal();">+</button>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="user_group"
                                                                class="col-sm-2 col-form-label">Extension
                                                                <span class="text-danger">*</span> </label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control"
                                                                    onkeyup="allow_only_number(this.id);"
                                                                    onchange="check_extension(this.id,{{ $organization_servicesID }} ,'add-agnet');"
                                                                    required value="{{ $last_extension }}" name="user"
                                                                    id="user">
                                                                <span style="color:red" id="extension-error"></span>
                                                                <span style="color:green" id="extension-success"></span>
                                                                <br>
                                                                <span style="color:red"
                                                                    id="error_extension-error"></span>
                                                                <span style="color:green"
                                                                    id="success_extension-success"></span>

                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="name" class="col-sm-2 col-form-label">SMS
                                                                Number</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control"
                                                                    name="Sms_number" id="Sms_number">
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label for="user_group"
                                                            ...
                                                            <div class="col-sm-10">
                                                                ...
                                                                @endphp
                                                                <select name="user_group" class="form-control select3"
                                                                    id="user_group">
                                                                    <option value="" selected disabled>Select Role
                                                                    </option>
                                                                    @foreach ($responses as $response)
                                                                    <option value="{{ $response }}" {{
                                                                        isset($dailer_agent_user['user_group']) &&
                                                                        $dailer_agent_user['user_group']==$response
                                                                        ? 'selected' : '' }}>
                                                                        {{ $response }}
                                                                    </option>
                                                                    @endforeach
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="full_name" class="col-sm-2 col-form-label">Name
                                                                <span class="text-danger">*</span></label>
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" required
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="active" class="col-sm-2 col-form-label">Status
                                                                <span class="text-danger">*</span></label>
                                                            <div class="col-sm-10">
                                                                <select class="form-control select4" required
                                                        ...
                                                        <div class="form-group row">
                                                            <label for="active" class="col-sm-2 col-form-label">Get
                                                                Skills From Agent:</label>
                                                            ...
                                                            ?>
                                                                ...
                                                                <select class="form-control select3" name="other_user"
                                                                    id="other_user">
                                                                    <option value="" selected>Disabled</option>
                                                                    <?php foreach ($userAgents as $i => $userAgent) : ?>
                                                                    <option value="<?= $userAgent->user ?>">
                                                                        <?= $userAgent->user ?> |
                                                                        <?= $userAgent->full_name ?>
                                                                    </option>
                                                                    <?php endforeach; ?>
                                                        ...
                                                        <div class="row justify-content-end">
                                                            <div class="col-md-2 ">
                                                                <button type="button" id="extension_val_idd"
                                                                    class="btn btn-primary" style="margin-left: 100px;"
                                                                    onclick="validateAndNext() , copy_agent_skill();">Next</button>
                                                            </div>
                                                    ...
                                                    <div id="skills-part" class="content" role="tabpanel"
                                                        aria-labelledby="skills-part-trigger">
                                                        <div class="card-header">
                                                            <h3 class="card-title"><b>Inbound:</b></h3>
                                                        </div>
                                                        <div class="card-body">
                                                            <table id="compaignnse"
                                                                class="table table-striped table-hover vonexta-table">
                                                                <thead>
                                                                    <tr>
                                                                        <th>Name</th>
                                                                        <th>Level</th>
                                                                ...
                                                                <tbody id="append-html-agent-inblound">
                                                                    ...
                                                                    @foreach ($skills['Inbound']['group_id'] as $row =>
                                                                    $call_log_inbound)
                                                                    <tr>
                                                                        <td>
                                                                            <input type='text'
                                                                                id="model_group_id_{{ $skills['Inbound']['group_id'][$row] }}"
                                                                                readonly value='{{ $skills['
                                                                                Inbound']['group_id'][$row] }}'
                                                                                name='group_id[]'
                                                                                style='border:none;background: transparent;' />
                                                                            <span class="adminlet3"
                                                                                onclick="open_inbound_model('{{ $skills['Inbound']['group_id'][$row] }}');"><i
                                                                        ...
                                                                        <td>
                                                                            <select class="form-control select4"
                                                                                style="border: none;"
                                                                                id="model_level_{{ $skills['Inbound']['group_id'][$row] }}"
                                                                                name='level[]'>
                                                                        ...
                                                                        <td>
                                                                            <input type="checkbox"
                                                                                id="model_invited_{{ $skills['Inbound']['group_id'][$row] }}"
                                                                                name='row_{{ $skills['
                                                                                Inbound']['group_id'][$row] }}'
                                                                                class="form-check-input inbound-checkbox"
                                                        ...
                                                        <div class="card-body">
                                                            <div class="row mb-3">
                                                                <div class="col-md-4 mt-2">
                                                                    ...
                                                                    <input id="max_inbound_calls" type="text"
                                                                        default="1000" name="max_inbound_calls"
                                                                        value="">
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="card-body">
                                                            <table id="compaignns"
                                                                ...
                                                                <tbody id="append-html-agent-compaign">
                                                                    ...
                                                                    @foreach ($skills['Campaigns']['campaign_id'] as
                                                                    $row => $call_log_Campaigns)
                                                                    <tr>
                                                                        <td><input
                                                                                id="model_campaign_id_{{ $skills['Campaigns']['campaign_id'][$row] }}"
                                                                                type='text' readonly value='{{ $skills['
                                                                                Campaigns']['campaign_id'][$row] }}'
                                                                                name='campaign_id[]'
                                                                                style='border:none;background: transparent;' />
                                                                            <span class="adminlet3"
                                                                                onclick="open_outbound_model('{{ $skills['Campaigns']['campaign_id'][$row] }}');"><i
                                                                                    class="fas fa-list"></i></span>
                                                                        </td>
                                                                        <td>
                                                                            <select class="form-control select4"
                                                                                style="border: none;"
                                                                                id="model_comp_level_{{ $skills['Campaigns']['campaign_id'][$row] }}"
                                                                                name='campaign_id_level[]'>
                                                        ...
                                                        <div class="row justify-content-between">
                                                            ...
                                                            <div class="col-md-4">
                                                                <button type="submit" class="btn btn-primary"
                                                                    style="margin-left: 259px;"
                                                                    onclick="add_agent()">Save</button>
                                                            </div>
                                                        </div>
                                                    </div>
            ...
            <div class="bs-stepper" id="newUserWizard">
                <div class="modal-dialog modal-xl">
                    <div class="modal-content">
                        ...
                        <form action="{{ route('services.bulk-save-agent', ['service' => strtolower('Dailer')]) }}"
                            method="post" id="bulk_agent_save_form">
                            @csrf
                            <input type="hidden" name="organization_servicesID" id="organization_servicesID"
                                value="{{ $organization_servicesID }}">
                            <input type="hidden" name="orgID" value="{{ $organization->id }}">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-control select3" name="other_user" id="other_user_bulk">
                                        ...
                                        <option value="{{ $userAgent->user }}"> {{ $userAgent->user }} |
                                            {{ $userAgent->full_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody class="add_row">
                                        <tr id="1">
                                            <td>
                                                <select class="form-control select3" name="email[]" id="email_1"
                                                    style="width: 100%;">
                                            ...
                                            <td><input type="text" class="form-control"
                                                    onkeyup="allow_only_number(this.id);"
                                                    onchange="check_extension(this.id,{{ $organization_servicesID }} ,'add-bulk-agnet');"
                                                    name="extension[]" id="extension_1">
                                            ...
                                            {{-- <td><input type="password" class="form-control" name="password[]"
                                                    id="password_1"></td> --}}
                                            <td>
                                                <select class="form-control select3" required name="active[]"
                                                    id="active_1">
                                                    <option value="1">Active</option>
        ...
        <div class="modal fade" id="add_organization_user">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- form start -->
                        <form id="systemUsersForm"
                            action="{{ route(' administration.users.store_user_by_agent_side') }}" method="post"
                            ...
                            <div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-control select3" id="role" name="role"
                                            value="{{ old('role') }}" onchange='toggal_service();'>
                                ...
                                <div class="form-group row" id='div_services'>
                                    ...
                                    <div class="col-sm-10">
                                        <div class="row" id="Services_row" @error('Services') aria-invalid="true"
                                            @enderror>
                                            @foreach ($user_have_service as $Services)
                                            <div class="col-sm-6 mb-3">
                                                <div class="form-check">
                                                    <input type="checkbox" class="form-check-input"
                                                        id="{{ str_replace(' ', ' _', $Services->user_have_service->service_nick_name) }}"
                                                        name="Services[]" data-bootstrap-switch data-off-color="danger"
                                                        data-on-color="success" checked
                                                        value="{{ $Services->user_have_service->id }}">
                                                    <label class="form-check-label"
                                                        for="{{ str_replace(' ', ' _', $Services->user_have_service->service_nick_name) }}">
                                                        {{ ucwords($Services->user_have_service->service_nick_name)
                                                        }}</label>
                                                </div>
                                            </div>
                                            @endforeach
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                        <button type="button" onclick="save_systemUsersForm();" class="btn btn-primary">Save
                            changes</button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="card-body">
                            <div class="row mb-3">
                                <div class="col-md-4 mt-2">
                                    <label> Inbound Calls Limit: </label>
                                    <input id="max_inbound_calls1" type="text"
                                        oninput="update_inblound_call_limit(this.id);" name="max_inbound_calls1"
                                        value="{{ isset($dailer_agent_user['max_inbound_calls']) ? $dailer_agent_user['max_inbound_calls'] : '' }}">
                                </div>
                            </div>
                        </div>
