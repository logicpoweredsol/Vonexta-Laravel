        ...
        <section class="content">
            ...
            <div class="card-body" style="position: relative;">
                    <div class="acbz" style="position: absolute;width: 250px;right: 275px;top: 20px ;z-index:9;">
                        ...
                        <!-- <select class="form-control" id="search_filter" style="height: 32px;
                padding: 5px;
                font-size: 14px;">
                                                ...
                                                <div id="Users-part" class="content" role="tabpanel" aria-labelledby="Users-part-trigger">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            @endphp
                                                            <select name="user_group" class="form-control select3" id="user_group">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <select class="form-control select4" required name="active" id="active">
                                                    ...
                                                    <div class="card-body">
                                                        <table id="compaignnse" class="table table-striped table-hover vonexta-table">
                                                            ...
                                                            @if($skills['Inbound']['result'] == 'success')
                                                                ...
                                                                <tr>
                                                                <td>
                                                                        <input type='text' id="model_group_id_{{$skills['Inbound']['group_id'][$row]}}" readonly value='{{$skills['Inbound']['group_id'][$row]}}' name='group_id[]' style='border:none;background: transparent;' />
                                                    ...
                                                    <div class="card-body">
                                                        <div class="row mb-3">
                                                            <div class="col-md-4 mt-2">
                                                                ...
                                                                <input id="max_inbound_calls" type="text" default="1000" name="max_inbound_calls" value="">
                                                            </div>
                                                        </div>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <tbody class="add_row">
                                    <tr id="1">
                                        ...
                                        <td>
                                            <select class="form-control select3" required name="active[]" id="active_1">
                                                <option value="1">Active</option>
